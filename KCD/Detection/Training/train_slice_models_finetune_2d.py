...
def train_cv_slice_model_2d(home = '/Users/mcgoug01/Downloads/Data/',dataname='coreg_ncct',pretrain_ds='kits23_nooverlap',
    ...
    for split in splits:
        ...
        for fold,train_index, test_index in fold_split:
            ...
            model = torch.load('/bask/projects/p/phwq4930-renal-canc/KCD_data/Data/training_info/{}/split_0/fold_2/TileModel/model/TileModel_small_5_10_0.001'.format(pretrain_ds))
            ...
            model_name = 'TESTMODEL_EFFNET_{}_{}_{}_{}_{}'.format(model_type,params['model_size'],params['epochs'],params['pred_window'],params['lr'])
