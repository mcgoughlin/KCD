...
def train_cv_slice_model(home = '/Users/mcgoug01/Downloads/Data/',dataname='coreg_ncct',pretrain_ds='kits23_nooverlap',
    ...
    for split in splits:
        ...
        for fold,train_index, test_index in fold_split:
            ...
            model = torch.load('/bask/projects/p/phwq4930-renal-canc/KCD_data/Data/training_info/{}/split_0/fold_2/PatchModel/model/PatchModel_resnext_small_30_30_0.001'.format(pretrain_ds))
            ...
            model_name = 'TESTMODEL_RESNEXT_{}_{}_{}_{}_{}_{}'.format(pretrain_ds,model_type,params['model_size'],params['epochs'],params['epochs'],params['lr'])
