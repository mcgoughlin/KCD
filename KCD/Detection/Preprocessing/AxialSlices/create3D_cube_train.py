...
overlap_mm = 16 ## this dictates the minimum distance apart between each slice! not the overlap.
patch2d = 32 ## in plane slice spacing
save_limit_percase_perlabel = 250 ## maximum number of saved shifted window slices per kidney
...
depth_z = 32 ## size of slice depth in axial dimension in mm - if 1mm, then 2D
bbox_boundary_mm = 40 ## dilation of segmentation label
boundary_z= 16 ## axial spacing between slice sampling
