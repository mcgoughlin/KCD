...
home = '/Users/mcgoug01/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/SecondYear/Classification/object_dataset/'
...
save_dir_CD = os.path.join(home,dataset_CD)
is_testing_code=False
overwrite=False


ocu.create_labelled_dataset(dataset_CD,im_p,infnpy_p,infnii_p,lb_p,save_dir_CD,
...
save_dir_k23 = os.path.join(home,dataset_k23)
is_testing_code=False
overwrite=False


ocu.create_labelled_dataset(dataset_k23,im_p,infnpy_p,infnii_p,lb_p,save_dir_k23,
                        is_testing=is_testing_code,overwrite=overwrite)
