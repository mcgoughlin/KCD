...
def seg_2_mesh(segmentation,dataset='kits_ncct', show=True):
    if (dataset=='kits_ncct') or (dataset=='coreg_ncct'):
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        ...
        if (dataset=='coreg_ncct'):
            ...
            lb_p = '/Users/mcgoug01/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/SecondYear/Segmentation/seg_data/raw_data/kits23sncct/labels/'
            infnii_p = '/Users/mcgoug01/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/SecondYear/Segmentation/seg_data/predictions_nii/{}/[4 4 4]mm/'.format(dataset)
        ...
        ########### LOAD DATA #############
            ...
            if is_kits19ncct or (dataset=='coreg_ncct'):
        ...
        ########### GENERATE FEATURES #############
            ...
            lr_index = assign_lrindex(is_kits19ncct or (dataset=='coreg_ncct'))
            ...
            if not (dataset=='coreg_ncct'):
                if not ((lb.shape[0]==512) and (lb.shape[2] == 512)): 
