...
model_name = '6,3x3x3,32_finetune_fromkits23-trainontest'
...
for vf in vfs:
    path_to_model = '/bask/projects/p/phwq4930-renal-canc/data/seg_data/trained_models/kits23/2mm_binary_canceronly/6,3x3x3,32_justcancer_trainontest/fold_1/network_weights'
